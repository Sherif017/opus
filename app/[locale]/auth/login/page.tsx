    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white flex flex-col">
      ...
      <nav className="border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <Link 
            href="/" 
            className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent hover:opacity-80 transition-opacity"
          >
            OPUS
          </Link>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/30 border border-slate-700 rounded-xl sm:rounded-2xl p-6 sm:p-8 backdrop-blur-sm">
            <div className="mb-6 sm:mb-8">
              ...
              <p className="text-sm sm:text-base text-slate-400">Accédez à votre compte Opus</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-2 text-xs sm:text-sm">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 sm:py-3 rounded-lg font-semibold bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-blue-500/30 text-white mt-6 sm:mt-8 text-sm sm:text-base"
              >
          ...
          {/* Info box */}
          <div className="mt-6 p-3 sm:p-4 bg-slate-800/30 border border-slate-700 rounded-lg">
