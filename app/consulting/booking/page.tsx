    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-600 to-blue-800">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Link href="/consulting" className="flex items-center gap-2 mb-6 hover:opacity-80 transition-opacity w-fit">
            <ArrowLeft size={24} />
            <span>Retour</span>
          </Link>

          <h1 className="text-5xl font-bold mb-4">Réserver votre audit gratuit</h1>
          <p className="text-xl opacity-90">30 minutes pour identifier vos gains</p>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        {success && step === 4 && (
          <div className="bg-green-500/20 border border-green-500 rounded-lg p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Audit réservé! 🎉</h2>
            <p className="text-gray-200 mb-6">
              Vérifiez votre email pour les détails de votre rendez-vous.
              Nous vous contacterons dans les 24h pour confirmer.
            </p>
            <Link href="/">
              <button className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-bold transition-colors">
                Retour à l'accueil
              </button>
            </Link>
          </div>
        ...
        {step < 4 && (
          <form onSubmit={handleSubmit} className="bg-gray-900 rounded-xl p-8 text-white">
            {/* Step Indicator */}
            ...
            {step === 1 && (
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-semibold mb-2">Prénom et Nom *</label>
                    <input
                      type="text"
                      name="fullName"
            ...
            {step === 3 && (
              <div>
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-2xl font-bold">Votre situation</h2>
                </div>

                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-semibold mb-2">Quel est votre plus grand défi? *</label>
                    <textarea
                      name="challenge"
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2">Date préférée *</label>
                    <input
                      type="date"
                      name="preferredDate"
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2">Heure préférée *</label>
                    <select
                      name="preferredTime"
            ...
            <div className="flex gap-4 mt-8">
              ...
              {step === 3 && (
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-6 py-3 bg-green-600 hover:bg-green-700 disabled:bg-green-800 text-white rounded-lg font-bold transition-colors"
                >
