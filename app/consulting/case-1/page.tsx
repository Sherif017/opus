    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-slate-800 rounded-xl p-8 mb-8 border border-slate-700">
          <h2 className="text-3xl font-bold text-white mb-6">📊 L'Entreprise</h2>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="bg-slate-700/50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-blue-400">30</div>
              <div className="text-sm text-slate-300">Employés</div>
            </div>
            <div className="bg-slate-700/50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-blue-400">Menuiserie</div>
              <div className="text-sm text-slate-300">Secteur</div>
            </div>
            <div className="bg-slate-700/50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-blue-400">Rhône-Alpes</div>
              <div className="text-sm text-slate-300">Région</div>
            </div>
            <div className="bg-slate-700/50 p-4 rounded-lg">
              <div className="text-2xl font-bold text-blue-400">2025</div>
              <div className="text-sm text-slate-300">Année projet</div>
            </div>
          </div>
        </div>

        {/* AVANT */}
        <div className="bg-red-900/20 border-l-4 border-red-500 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-white mb-6">❌ AVANT: La Douleur</h2>
        ...
        {/* APRÈS */}
        <div className="bg-green-900/20 border-l-4 border-green-500 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-white mb-6">✅ APRÈS: La Solution</h2>
          ...
          <div className="bg-slate-700/50 p-4 rounded border border-green-400/30">
        ...
        <div className="bg-slate-700/50 border border-slate-600 rounded-lg p-8 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-lg text-slate-100 mb-4 italic">
